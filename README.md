...
See [https://docs.npmjs.com/files/package.json](NPM docs) for more details.
...
The files in the directory represent the records in the key-value store
- the name of each file corresponds to its key and the content to the value.
